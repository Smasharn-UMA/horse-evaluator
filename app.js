(()=>{'use strict';
const K='horseEvaluator3',V='3.1.11',UI_K='horseEvaluator3_ui',PRE_IMPORT_K='horseEvaluator3_preImportBackup',$=id=>document.getElementById(id);let state=load();
...
$('clearBtn').onclick=()=>{if(confirm('全データを削除しますか？')){state=base();save();render()}};refreshFilters();loadUi();render();})();
