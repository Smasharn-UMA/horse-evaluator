...
(()=>{'use strict';
const K='horseEvaluator3',V='3.1.49',SCHEMA_VERSION=7,UI_K='horseEvaluator3_ui',PRE_IMPORT_K='horseEvaluator3_preImportBackup',PHOTO_DB='horseEvaluator3_photos',PHOTO_STORE='photos',VIDEO_DB='horseEvaluator3_videos',VIDEO_STORE='videos',$=id=>document.getElementById(id);let state;
...
function openBlindReevaluation(){blindRenderDialog();$('blindReevalDialog').showModal();requestAnimationFrame(()=>$('blindReevalDialog').scrollTop=0)}
